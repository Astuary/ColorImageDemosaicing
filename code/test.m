left=imread('../data/disparity/tsukuba_im1.jpg');
right=imread('../data/disparity/tsukuba_im5.jpg');

left = imread('../data/disparity/poster_im2.jpg');
right = imread('../data/disparity/poster_im6.jpg');
